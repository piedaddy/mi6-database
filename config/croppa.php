<?php return array(
    ...
    */
    ...
    //now if the image already exists, then loading of image is left up to server, php doesnt have to do anything only unless the thumbnail doesnt exist, then croppa will come and make it 
